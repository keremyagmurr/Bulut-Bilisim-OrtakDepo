...
const QUESTIONS = [
  ...
  { category: "Satranç", difficulty: "Kolay", type: "chess",
    ...
    options: ["Re7", "Rg1", "Re8#", "Rf1"], answer: 2 },
  { category: "Satranç", difficulty: "Orta", type: "chess",
    ...
    options: ["d4", "Nxc6 (Çatal!)", "Nf3", "Bc4"], answer: 1 },
  { category: "Satranç", difficulty: "Kolay", type: "chess",
  ...
  { category: "Satranç", difficulty: "Orta", type: "chess",
    ...
    options: ["Qf3", "Qxf7# (Mat!)", "Nc3", "d3"], answer: 1 },
  { category: "Satranç", difficulty: "Zor", type: "chess",
    ...
    options: ["Bg5", "a3", "O-O", "Bxf7+ (Çatal!)"], answer: 3 },
  { category: "Satranç", difficulty: "Kolay", type: "chess",
    question: "Beyaz oynar. 1 hamlede mat! Hangi hamle mat eder?",
    fen: "k7/8/1K6/8/8/8/8/7R w - - 0 1",
    options: ["Rh7", "Kb6", "Rh8#", "Ka6"], answer: 2 },
  ...
  { category: "Fark Bul", difficulty: "Kolay", type: "spotdiff",
    ...
    grid1: ["⭐","🌙","☀️","🌈","⚡","❄️","🔥","💧","🌊"],
    grid2: ["⭐","🌙","☀️","🌈","🌟","❄️","🔥","💧","🌊"],
    options: ["Satır 1 Sütun 1", "Satır 3 Sütun 1", "Satır 2 Sütun 2 (⚡→🌟)", "Satır 1 Sütun 3"], answer: 2 },
